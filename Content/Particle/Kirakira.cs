...
{
    public class Kirakira : BaseParticle
    {
        public float VelocityRot = 0;
        public override BlendState BlendState => BlendState.Additive;
        public Kirakira(Vector2 position, Vector2 velocity, Color color, int lifetime, float Rot)
        {
            Position = position;
            Velocity = velocity;
            DrawColor = color;
        ...
        public override void Update()
        {
            ...
            Scale = MathHelper.Lerp(0.05f, 0f, EasingHelper.EaseInCubic(LifetimeRatio));
